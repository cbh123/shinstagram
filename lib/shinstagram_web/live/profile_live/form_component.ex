defmodule ShinstagramWeb.ProfileLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      >
        ...
        <.input field={@form[:profile_photo]} type="text" label="Profile photo" />
  ...
  defp save_profile(socket, :new, profile_params) do
    profile_params =
      Map.update(profile_params, "username", profile_params["username"], &String.downcase(&1))
