defmodule ShinstagramWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ShinstagramWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ShinstagramWeb.Gettext, "errors", msg, opts)
    end
  end
