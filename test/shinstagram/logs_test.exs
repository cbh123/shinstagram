defmodule Shinstagram.LogsTest do
  ...
  describe "logs" do
    ...
    import Shinstagram.LogsFixtures
  ...
  describe "logs" do
    ...
    @invalid_attrs %{event: nil, status: nil}
    ...
    test "create_log/1 with valid data creates a log" do
      valid_attrs = %{event: "some event", status: "some status"}
    ...
    test "update_log/2 with valid data updates the log" do
      log = log_fixture()
      update_attrs = %{event: "some updated event", status: "some updated status"}
